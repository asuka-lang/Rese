...

{
    ...
    public function run()
    {
        $param = [
            ...
            'image' => asset('storage/img/sushi.jpg')
        ];
        ...
        $param = [
            ...
            'image' => asset('storage/img/yakiniku.jpg')
        ];
        DB::table('shops')->insert($param);
        $param = [
            'title' => '戰慄',
            ...
            'image' => asset('storage/img/izakaya.jpg')
        ];
        DB::table('shops')->insert($param);
        $param = [
            'title' => 'ルーク',
            ...
            'image' => asset('storage/img/italian.jpg')
        ];
        DB::table('shops')->insert($param);
        $param = [
            'title' => '志摩屋',
            ...
            'image' => asset('storage/img/ramen.jpg')
        ];
        DB::table('shops')->insert($param);
        $param = [
            'title' => '香',
